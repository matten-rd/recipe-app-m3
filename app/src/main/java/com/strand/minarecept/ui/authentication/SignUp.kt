...
import com.strand.minarecept.util.isValidEmail
import com.strand.minarecept.util.isValidPassword
...
fun SignUpScreen(
    ...
    when (uiState) {
        ...
        UiState.SignedIn -> onSuccessfulSignUp() // navigates to saved recipes screen
        UiState.SignedOut -> SignUpContent(contentPadding, onSignInAction)
    }
}
    ...
    val launcher = rememberLauncherForActivityResult(
        ...
        if (result.resultCode == Activity.RESULT_OK) {
            ...
            try {
                ...
                Log.w("FIREBASE", "Google sign up failed", e)
            }
        }
    }
    ...
    Column(
        ...
        Column(
            ...
            RecipeButton(
                ...
                onClick = {
                    // TODO: Display error when email or password is not valid
                    if (email.isValidEmail() && password.isValidPassword()) {
                        authViewModel.onCreateUser(email, password)
                    }
                }
            ) {
        ...
        Column(
            ...
            TextButton(onClick = onSignInAction) {
