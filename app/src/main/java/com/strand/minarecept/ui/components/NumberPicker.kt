...
fun NumberPicker(
    ...
    // Get height of all possible numbers combined
    ...
    Column(
        ...
        val isAboveLowerBound: Boolean = animatedStateValue > range.first
        val isUnderUpperBound: Boolean = animatedStateValue < range.last

        Box(
            modifier = Modifier
                .align(Alignment.CenterHorizontally)
                .offset { IntOffset(x = 0, y = coercedAnimatedOffset.roundToInt()) }
                .height(halvedNumbersColumnHeight * 4)
                .fillMaxWidth()
        ) {
            ...
            ProvideTextStyle(textStyle) {
                Label(
                    ...
                    modifier = baseLabelModifier
                        ...
                        .alpha(coercedAnimatedOffset / halvedNumbersColumnHeightPx + if (isAboveLowerBound) 0.5f else 0f)
                )
                Label(
                ...
                Label(
                    ...
                    modifier = baseLabelModifier
                        .offset(y = halvedNumbersColumnHeight)
                        .alpha(-coercedAnimatedOffset / halvedNumbersColumnHeightPx + if (isUnderUpperBound) 0.5f else 0f)
                )
            }
        }
